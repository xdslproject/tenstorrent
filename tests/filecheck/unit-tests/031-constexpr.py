...
# CHECK-NEXT:       %2 = "ttshared.get_compile_time_arg_val"(%1) : (ui32) -> !constexpr<ui32>
# CHECK-NEXT:       %a = memref.alloc() : memref<!constexpr<ui32>>
# CHECK-NEXT:       memref.store %2, %a[] : memref<!constexpr<ui32>>
