...
builtin.module {
  func.func @"example_add"() {
    ...
    linalg.sub ins(%0, %1 : memref<32x32xf32>, memref<32x32xf32>) outs(%3 : memref<32x32xf32>) -> ()
...
// CHECK: "comp.sub_tiles_init"(%2, %3, %6) : (i32, i32, i1) -> ()
// CHECK: "comp.tile_regs_acquire"() : () -> ()
// CHECK: "comp.sub_tiles"(%2, %3, %0, %0, %0) : (i32, i32, i32, i32, i32) -> ()
