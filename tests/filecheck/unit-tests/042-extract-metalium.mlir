...
// CHECK-NEXT:       %26 = "tthost.create_kernel"(%6, %11) <{kernel_name = "run_data_in", riscv_core = #tthost.riscv_core<compute>, noc_id = #builtin.int<0>}> : (!tthost.program, !tthost.corecoord) -> !tthost.kernel
// CHECK-NEXT:       %27 = "tthost.create_kernel"(%6, %11) <{kernel_name = "run_data_out", riscv_core = #tthost.riscv_core<compute>, noc_id = #builtin.int<1>}> : (!tthost.program, !tthost.corecoord) -> !tthost.kernel
