...
builtin.module {
  func.func @"example_independent"() {
    ...
    linalg.matmul ins(%4, %5 : memref<32x32xi32>, memref<32x32xi32>) outs(%7 : memref<32x32xi32>) -> ()
...
// CHECK-NEXT:       %4 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<32x32xi32>
// CHECK-NEXT:       %5 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<32x32xi32>
// CHECK-NEXT:       %6 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<32x32xi32>
// CHECK-NEXT:       %7 = "memref.alloca"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<32x32xi32>
// CHECK-NEXT:       func.call @host_entry_1(%4, %5, %7) : (memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>) -> ()
// CHECK-NEXT:       "memref.copy"(%7, %6) : (memref<32x32xi32>, memref<32x32xi32>) -> ()
...
// CHECK-NEXT:     func.func private @host_entry_1(memref<32x32xi32>, memref<32x32xi32>, memref<32x32xi32>) -> ()
// CHECK-NEXT:   }
