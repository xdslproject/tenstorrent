...
builtin.module {
  builtin.module {
    func.func @example_independent() {
      ...
      func.call @host_entry_1(%4, %5, %7) : (memref<32x32xf32>, memref<32x32xf32>, memref<32x32xf32>) -> ()
    ...
    func.func private @host_entry_1(memref<32x32xf32>, memref<32x32xf32>, memref<32x32xf32>) -> ()
  }
  ...
  builtin.module attributes {kernel_type = "host", vis = "external"} {
    func.func @host_entry_1(%0 : memref<32x32xf32>, %1 : memref<32x32xf32>, %2 : memref<32x32xf32>) {
      %zero = arith.constant 0 : i32
      func.return
    }
  }
...
// CHECK:     func.func @kernel_main(%bank_id : i32, %mem_addr : i32, %size_bytes : i32) {
// CHECK:       %0 = "dm.get_noc_addr_from_bank_id"(%bank_id, %mem_addr) <{dram = true}> : (i32, i32) -> i64
// CHECK:       func.return
// CHECK:     }
// CHECK:   }
// CHECK:   builtin.module attributes {kernel_type = "host", vis = "external"} {
